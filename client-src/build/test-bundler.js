...
// require all `src/**/*.jsx?` except for spec files, stories, and `main.js` (for isparta coverage reporting)
if (__COVERAGE__) {
  const componentsContext = require.context('../src/', true, /^((?!main\.)(?!\.story\.)(?!\.spec\.).)*\.jsx?$/);
