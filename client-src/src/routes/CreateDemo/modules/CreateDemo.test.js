...
test('(Constant) GET_QUOTE === "CreateDemo/GET_QUOTE"', t => {
  t.is(GET_QUOTE, 'CreateDemo/GET_QUOTE');
});

test('(Constant) RECEIVE_QUOTE === "CreateDemo/RECEIVE_QUOTE"', t => {
  t.is(RECEIVE_QUOTE, 'CreateDemo/RECEIVE_QUOTE');
});
