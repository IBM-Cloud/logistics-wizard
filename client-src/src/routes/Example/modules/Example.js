...
// Constants
// ------------------------------------
export const UPDATE_TITLE = 'Example/UPDATE_TITLE';
export const GET_QUOTE = 'Example/GET_QUOTE';
export const RECEIVE_QUOTE = 'Example/RECEIVE_QUOTE';
...
// This is set up in `../index.js` as the key in  `injectSagas(store, { key: 'example', sagas });`
...
export function *watchGetQuote() {
  while (true) {
    ...
    const state = yield select(exampleSelector);
    if (!state.quote) {
